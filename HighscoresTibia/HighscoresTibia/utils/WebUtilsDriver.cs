...
namespace BandejaoUFRJ.utils
{
    public class WebUtilsDriver : IDisposable
    {
        ...
        //private const string ACCEPT_USERAGENT   = "Mozilla/5.0 (Windows NT 6.1; compatible; BDCbot/1.0; +http://ecommerce.bigdatacorp.com.br/faq.aspx)"
        //                                        + " AppleWebKit/535.1 (KHTML, like Gecko) Chrome/13.0.782.107 Safari/535.1";
        //private const string ACCEPT_USERAGENT   = "Mozilla/5.0 (Windows NT 6.1; compatible)"
        //                                        + " AppleWebKit/535.1 (KHTML, like Gecko) Chrome/13.0.782.107 Safari/535.1";
        private const string COVERT_USERAGENT   = "Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; EIE11;ENUSMSN; rv:11.0) like Gecko";
        //private const string COVERT_USERAGENT   = "Mozilla/5.0 (Windows NT 6.1; compatible;)"
        //                                        + " AppleWebKit/535.1 (KHTML, like Gecko) Chrome/13.0.782.107 Safari/535.1";
